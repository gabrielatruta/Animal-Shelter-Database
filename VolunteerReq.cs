...
namespace DbProject
{
    public partial class VolunteerReq : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (MySqlCommand cmdd = new MySqlCommand("SELECT * FROM adoptionzalau.vol_req", con))
                {
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "update adoptionzalau.vol_req set Name='" + this.textBox2.Text + "', Age='" + this.textBox3.Text + "', Address='" + this.textBox4.Text + "', Email='" + this.textBox5.Text + "', Phone= '"+this.textBox6.Text+ "', Status= '"+this.textBox7.Text+"' where idvol_Req= '" + this.textBox1.Text + "';";
        ...
        {
            con.Open();
            string delete_row = "delete from adoptionzalau.vol_req where idvol_Req= '" + this.textBox1.Text + "';";
